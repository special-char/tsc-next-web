    ...
    <div className="profile-card">
      ...
      <Link href={'#'} className='w-full !no-underline'>
        <div className='mx-auto flex flex-col md:flex-row md:gap-0 md:justify-between md:w-full md:place-self-start gap-2 mb-5'>
          ...
          <span className='chip chip--primary max-w-max !py-2 px-5 md:grid mx-auto md:place-content-end '>Design</span>
        </div>
        <p className='!text-center m-0 md:!text-left mb-6'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex harum ea optio qui, ducimus corporis neque. Ducimus deserunt voluptas et praesentium veniam omnis, nostrum consequatur.</p>
