...
const TermsService = () => {
  ...
  return (
    <section className="px-4 md:px-container py-16" id="termsservice">
      ...
      <p>
        This Website Standard Terms and Conditions written on this webpage shall
        manage your use of our website, edtechgcc accessible at{' '}
        <a href="https://thespecialcharacter.com/">
          www.thespecialcharacter.com
        </a>
        .
      </p>
      ...
      <p>Minors are not allowed to use this Website.</p>

      <h3>Intellectual Property Rights</h3>
      <p>
        Other than the content you own, under these Terms, EDTECH TRAINING AND
        CONSULTANCY and/or its licensors own all the intellectual property
      ...
      <p>
        ...
        <ul>
          ...
          <li>Using this Website in any way that may be damaging;</li>
          <li>
          ...
          <li>Using this Website for any advertising or marketing.</li>
        </ul>
      </p>
      <p>
        Certain areas of this Website are restricted from being accessed by you,
        and EDTECH TRAINING AND CONSULTANCY may further restrict access by you
        to any areas of this Website, at any time, in absolute discretion. Any
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant EDTECH
        TRAINING AND CONSULTANCY a non-exclusive, worldwide irrevocable,
      ...
      <p>
        ...
        rights. EDTECH TRAINING AND CONSULTANCY reserve the right to remove any
      ...
      <h4>No warranties</h4>
      <p>
        This Website is provided "as is," with all faults, and EDTECH TRAINING
        AND CONSULTANCY express no representations or warranties, of any kind
      ...
      <p>
        In no event shall EDTECH TRAINING AND CONSULTANCY, nor any of its
        ...
        whether such liability is under contract. EDTECH TRAINING AND
        CONSULTANCY, including its officers, directors, and employees shall not
      ...
      <p>
        You hereby indemnify to the fullest extent EDTECH TRAINING AND
        CONSULTANCY from and against any and/or all liabilities, costs, demands,
      ...
      <p>
        EDTECH TRAINING AND CONSULTANCY is permitted to revise these Terms at
        any time as it sees fit, and by using this Website you are expected to
        review these Terms on a regular basis.
      </p>
      <h4>Assignment</h4>
      <p>
        The EDTECH TRAINING AND CONSULTANCY are allowed to assign, transfer, and
      ...
      <p>
        These Terms constitute the entire agreement between EDTECH TRAINING AND
        CONSULTANCY and you in relation to your use of this Website and
