...
import LandingHeader from './Header/index';
...
const page = () => {
  return (
    // <div>
    //   {/* <section className="px-containers">
    ...
    //             <h1>
    //               Build Custom Websites like Apple, CRED without a single code
    //               using Webflow for your{' '}
    ...
    //     {/* <div className="flex flex-1 flex-col items-center px-5 md:px-0 ">
    //       <div className="   ">
    //         <div className="text-center text-3xl font-semibold md:text-4xl lg:px-32 lg:text-4xl ">
    //           <h1>
    //             Welcome to Tech Fest Powered by The Special Character, along
    //             with our knowledge partner Adani Institute of Digital Technology
    //             Management the most awaited technology event of the year!
    //           </h1>
    //         </div>
    //         <div className="py-5 text-lg md:text-3xl lg:px-16 lg:text-2xl">
    //           <h4 className="py-5 text-center text-lg md:px-8 md:text-3xl lg:px-80 lg:text-2xl  ">
    //             Design and animate highly responsive custom websites using
    //             Webflow and bring your Portfolio to life
    //           </h4>
    //         </div>
    //       </div>
    ...
    //     <div className="mx-4  flex flex-col justify-between gap-6 rounded-xl bg-neutral-800 text-center md:mx-12 md:flex-row md:px-6  lg:mx-44 lg:px-4 ">
    //       {/* <div className=" flex flex-col items-center justify-center   ">
    ...
    //       {/* <BorderLine className="md:hidden" /> */}
