...
const PrivacyPolicy = () => {
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          impossible for this Application to provide its services. Users are
          responsible for any Personal Data of third parties obtained, published
          or shared through this Application and confirm that they have the
          third party's consent to provide the Data to the Owner. Mode and place
          of processing the Data Methods of processing. The Data Controller
          ...
          Place. The Data is processed at the Data Controller's operating
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          documentation and to the Facebook privacy policy. The permissions
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          their Data public, more information will be available. Detailed
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          advertising network. Personal Data collected: Cookies and Usage Data.
          Place of processing: US â€“ Privacy Policy â€“ opt Out
          <br />
          ...
          this Application (System logs) or use for this purpose other Personal
  ...
  return (
    <section className="px-container py-20" id="PrivacyPolicy">
